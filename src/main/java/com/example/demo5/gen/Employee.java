 ...
 *         &lt;element name="linkingDate" type="{http://www.w3.org/2001/XMLSchema}date"/&gt;
...
public class Employee {
    ...
    @XmlElement(required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar linkingDate;
    @XmlElement(required = true)
     ...
     *     
     */
    public void setLinkingDate(XMLGregorianCalendar value) {
